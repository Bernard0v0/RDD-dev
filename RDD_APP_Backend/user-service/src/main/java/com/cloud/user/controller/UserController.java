...
import com.cloud.user.pojo.Result;
...
public class UserController {
    ...
    private static final String USER_POOL_ID = "cognito_pool_id";

    @PostMapping("/token")
    public Result register(String code, String type) {
        ...
        if (type.equals("mobile")) {
            body.add("redirect_uri", "mobile_app_name://callback");
        }
        else {
        ...
        String tokenUrl = "cognito_token_endpoint";
